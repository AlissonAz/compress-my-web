...
1. Baixe `CompressMyWeb-Setup-1.6.3-win-x64.exe` (ou o pacote portátil `.zip`) na página de [Releases](https://github.com/AlissonAz/compress-my-web/releases).
...
1. Baixe `compressmyweb_1.6.3_amd64.deb` na página de [Releases](https://github.com/AlissonAz/compress-my-web/releases).
2. Abra um terminal na pasta do arquivo baixado e instale o pacote:

```bash
sudo apt install ./compressmyweb_1.6.3_amd64.deb
```
